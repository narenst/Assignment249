...
Segment::Segment(Fwk::String name): Fwk::NamedInterface(name), shipmentsReceived_(0), shipmentsRefused_(0), capacity_(1), usage_(0), mode_(plane_), difficulty_(1.0), length_(1.0), expediteSupport_(false) {
	name_ = name;
