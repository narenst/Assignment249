...
//
////	    fleet->attributeIs("Daytime", "6.0,18.0");
//
//	    //Destination
...
//			    sourceRight[i]->attributeIs("Shipment Size", "100"); //convertIntToString(rand()%1000+1));
...
////	    cout << conn->attribute("explore sourceRight0_0 : distance 10000") << endl;
////	    cout << endl;
////
////	    cout << "*** connect source1 : destination ****" << endl;
////	    cout << conn->attribute("connect sourceRight0_0 : destination") << endl;
////	    cout << endl;
//
//	    // -- Statistics queries
...
////	    Ptr<Instance> activityManager = manager->instanceNew("activityManager", "RealTimeActivityManager");
//
